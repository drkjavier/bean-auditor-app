...
export async function setGenericPassword(username: string, password: string, _options?: any) {
  _token = password;
  return true;
}

export async function getGenericPassword(_options?: any) {
...
export async function resetGenericPassword(_options?: any) {
  _token = null;
  return true;
}
